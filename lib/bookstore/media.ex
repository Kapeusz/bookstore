defmodule Bookstore.Media do
  ...
  """
  def get_publisher!(slug), do: Repo.get_by!(Publisher, slug: slug)
  ...
  def create_publisher!(name) do
    Repo.insert!(%Publisher{name: name}, on_conflist: :nothing)
  end
  ...
  def list_alphabetical_publishers do
    Publisher
    |> Publisher.alphabetical()
    |> Repo.all()
  end
end
