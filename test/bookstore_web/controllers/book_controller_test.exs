defmodule BookstoreWeb.BookControllerTest do
  ...
  @create_attrs %{author_id: 42, category_id: 42, description: "some description", image_url: "some image_url", isbn: "some isbn", original_price: 120.5, published_on: ~D[2010-04-17], title: "some title"}
